<?php 
  ...
  if(isset($_POST['addPegawai'])) {
    ...
    $sql = "INSERT INTO pegawai (id_pegawai, nama_pegawai, tgl_lahir, jenis_kelamin, jabatan) VALUES ('$id', '$name', '$date', '$jk', '$jabatan')";

    $result = mysqli_query($conn, $sql);

    if($result) {
      $msg = "<div class='alert alert-success'>Add pegawai is succeed</div>";
